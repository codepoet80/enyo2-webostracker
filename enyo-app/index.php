...
?>
    ...
    <table style="margin-left:15%;margin-right:20%;font-size:small;">
        <tr><td width="22%" align="right"><b><a href="/index.html">PWA</a></b></td><td style="padding-left:18px">Progressive Web Apps work on modern browsers, and can be pinned to your home screen or dock on modern platforms.</td>
